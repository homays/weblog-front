                ...
                <div class="w-full py-5 px-2 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
                    <div class="flex flex-col items-center">
                        ...
                        <img class="w-24 h-24 mb-3 rounded-full shadow"
                            ...
                            alt="Bonnie image" />
                        <!-- 博主昵称 -->
                        <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Arrebol</h5>
                        <!-- 介绍语 -->
                        <span class="text-sm text-gray-500 dark:text-gray-400">Java工程师一枚</span>
                        <!-- 第三方平台主页跳转（如 GitHub 等） -->
                        <div class="flex justify-center mt-5 gap-2">
                            <!-- GitHub -->
                            <svg t="1698029949662" class="icon w-7 h-7" viewBox="0 0 1024 1024" version="1.1"
                            ...
                            <!-- Gitee -->
                            <svg t="1698030969736" class="icon w-7 h-7" viewBox="0 0 1024 1024" version="1.1"
                            ...
                            <!-- 知乎 -->
                            <svg t="1698031258903" class="icon w-7 h-7" viewBox="0 0 1024 1024" version="1.1"
                            ...
                            <!-- CSDN -->
                            <svg t="1698031311586" class="icon w-7 h-7" viewBox="0 0 1024 1024" version="1.1"
