        ...
        <div class="flex flex-col items-center">
            ...
            <div class="flex justify-center gap-2">
                ...
                <svg v-if="blogSettingsStore.blogSettings.githubHomepage" t="1698029949662"
                    ...
                    class="hover:scale-110 cursor-pointer icon w-7 h-7 mt-5 outline-none" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" @click="jump(blogSettingsStore.blogSettings.githubHomepage)"
