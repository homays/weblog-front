        ...
        <div class="flex flex-col items-center">
            ...
            <div class="flex justify-center gap-2">
                ...
                <svg v-if="blogSettingsStore.blogSettings.githubHomepage" t="1698029949662" data-tooltip-target="github-tooltip-bottom" data-tooltip-placement="bottom"
                    class="icon w-7 h-7 mt-5 outline-none" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" @click="jump(blogSettingsStore.blogSettings.githubHomepage)"
                ...
                <svg v-if="blogSettingsStore.blogSettings.giteeHomepage" t="1698030969736" data-tooltip-target="gitee-tooltip-bottom" data-tooltip-placement="bottom"
                    class="icon w-7 h-7 mt-5 outline-none" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    p-id="2438" width="200" height="200" @click="jump(blogSettingsStore.blogSettings.giteeHomepage)">
                    <path
                ...
                <svg v-if="blogSettingsStore.blogSettings.zhihuHomepage" t="1698031258903" data-tooltip-target="zhihu-tooltip-bottom" data-tooltip-placement="bottom"
                    class="icon w-7 h-7 mt-5 outline-none" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    p-id="3419" width="200" height="200" @click="jump(blogSettingsStore.blogSettings.zhihuHomepage)">
                ...
                <svg v-if="blogSettingsStore.blogSettings.csdnHomepage" t="1698031311586" data-tooltip-target="csdn-tooltip-bottom" data-tooltip-placement="bottom"
                    class="icon w-7 h-7 mt-5 outline-none" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    p-id="4386" width="200" height="200" @click="jump(blogSettingsStore.blogSettings.csdnHomepage)">
